...
{
    public class AttendanceTypeCategoryComparer : IEqualityComparer<Arena.Custom.SECC.Checkin.Entity.Occurrence>
    {
        ...
        public bool Equals(Arena.Custom.SECC.Checkin.Entity.Occurrence x, Arena.Custom.SECC.Checkin.Entity.Occurrence y)
        {
            ...
            return x.AttendanceTypeCategoryId == y.AttendanceTypeCategoryId;
        }
        ...
        public int GetHashCode(Arena.Custom.SECC.Checkin.Entity.Occurrence x)
        {
            ...
            return x.AttendanceTypeCategoryId;
        }
    }
}
